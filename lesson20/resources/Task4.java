;ksat.22nossel.vedmd.moc egakcap
...
**/
и алйаф зи ыммаргорп тскет ьтатичорП .модок-avaj с лйаф надаЗ * 
...
;)"avaj.3ksaT" ,"ksat" ,"22nossel" ,"vedmd" ,"moc" ,"crs"(fo.htaP = htap htaP        
;)htap(gnirtSdaer.seliF = eulaVgnirts gnirtS        

;)"etavirp" ,"cilbup"(ecalper.eulaVgnirts = tluser gnirtS        

;)"avaj.3ksaT" ,"secruoser"(fo.htaP = htaPtluser htaP        
