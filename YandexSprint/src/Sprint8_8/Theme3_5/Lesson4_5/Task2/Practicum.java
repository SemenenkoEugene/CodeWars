package Sprint8_8.Theme3_5.Lesson4_5.Task2;
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            if (response.statusCode() == 200) {
                ...
                long rateUSD = jsonObject.getAsJsonObject("rates").get("USD").getAsLong();
                long rateEUR = jsonObject.getAsJsonObject("rates").get("EUR").getAsLong();
