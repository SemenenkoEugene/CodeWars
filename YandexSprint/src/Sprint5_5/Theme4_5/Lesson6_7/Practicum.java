package Sprint5_5.Theme4_5.Lesson6_7;
...
public class Practicum {
    ...
    private static Set<Letter> letterSet = new TreeSet<>(Comparator.comparing(l -> l.dateReceived));
    ...
    public static void main(String[] args) {
        ...
        printOrderedByDateReceived(letterSet);
    }
